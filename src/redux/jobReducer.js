...
const initialState = {
    jobs: {},
    currentUser: {},
    status: ['Researching', 'Networking', 'Applying', 'Application Submitted', 'Assessments', 'Interviewing', 'Thank You Sent', 'Waiting for Response', 'Offer', 'Rejected', 'Negotiating', 'Accepted Offer', 'Rejected Offer']
}
